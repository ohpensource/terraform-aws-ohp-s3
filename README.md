...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_s3_bucket"></a> [s3\_bucket](#module\_s3\_bucket) | terraform-aws-modules/s3-bucket/aws | 2.3.0 |
...
| <a name="input_name"></a> [name](#input\_name) | (Optional, Forces new resource) The name of the bucket. If omitted, Terraform will assign a random, unique name. | `string` | `null` | no |
| <a name="input_object_lock_configuration"></a> [object\_lock\_configuration](#input\_object\_lock\_configuration) | Map containing S3 object locking configuration. | `any` | <pre>{<br>  "object_lock_enabled": "Enabled"<br>}</pre> | no |
...
| <a name="input_tags"></a> [tags](#input\_tags) | (Required) A mapping of tags to assign to the bucket. | `map(string)` | <pre>{<br>  "Client": "",<br>  "Datadog": "",<br>  "IacRepo": "https://bitbucket.org/...",<br>  "Service": "",<br>  "ServiceGroup": "",<br>  "Stage": "",<br>  "Team": "",<br>  "Version": ""<br>}</pre> | no |
